...
class USMSGH_Contact_Form_Sms_Notification_abn
{
	...
	{
		self::$functions = new USMSGH_Contact_Form_Sms_Notification_abn_Functions;
		if ($this->is_request('admin')) {
			$this->admin = new USMSGH_Contact_Form_Sms_Notification_abn_Admin;
		}
	}
	...
	{
		$this->define('Contact_FormSI_NAME', __('USMS-GH Contact Form 7 SMS Notification', 'cf7-sms-integration-abs')); # Plugin Name
...
if (!function_exists('Contact_FormSI')) {
	...
	{
		return USMSGH_Contact_Form_Sms_Notification_abn::get_instance();
	}
	Contact_FormSI();
}
